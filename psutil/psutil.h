        ...
        */
        ...
        public:
            ...
            /*
             ...
             @return 结果Mat
            */
            static PSUTILSHARED_EXPORT vector<Rect> findTextAreas(Mat src, int grayThresh = PS_DEFAULT_BINARY_THRESHOLD, Size blurSize = Size(3, 3));
            ...
            /*
             ...
             @return 结果Mat
             */
            static PSUTILSHARED_EXPORT Mat denoising(Mat src, Rect textArea, Size dSize, int grayThresh = PS_DEFAULT_BINARY_THRESHOLD, Size morphSize = Size(3, 3));
            /*
             @brief：(形态学闭运算)去噪 并填充至指定尺寸
             @param src : the source mat
             @param dSize: 目标尺寸
             ...
             @return 结果Mat
             */
            static PSUTILSHARED_EXPORT Mat denoising(Mat src, Size dSize, int grayThresh = PS_DEFAULT_BINARY_THRESHOLD, Size blurSize = Size(3, 3), Size morphSize = Size(3, 3));
            ...
            /**
             ...
             @return 结果Mat
            */
            static PSUTILSHARED_EXPORT Mat excerptTextArea(Mat src, Rect textArea, Size dSize);

            static PSUTILSHARED_EXPORT Mat textfill(Mat src, int grayThresh = PS_DEFAULT_BINARY_THRESHOLD, Size morph_size = Size(3, 3));
            ...
            /**
             ...
             @return 结果三通道BGR图
            */
            static PSUTILSHARED_EXPORT Mat replaceColors(Mat srcBin,Rect range, Vec3b(*colors)[2]);
        };
        ...
        public:
            ...
            static PSUTILSHARED_EXPORT void improve(const string& imgPath, Scalar colorPad= Scalar::all(255), int tolerant = PS_DEFAULT_TOLERANT_ROTATION, int grayThresh = PS_DEFAULT_BINARY_THRESHOLD, int houghVote = PS_DEFAULT_HOUGH_VOTE, Size blurSize = Size(3, 3), Size morphSize = Size(3, 3), Vec3b newbg = Vec3b(255, 255, 255),bool sharp = false, const HsvRngBGR bgrRng = PS_DEFAULT_BGR_RANGE_IN_HSV, const Vec3b standard[3] = PS_STANDARD_BGR);
            /*替换 背景色*/
            static PSUTILSHARED_EXPORT Mat replace_bgColor(Mat src, Vec3b bgrReplacer = Vec3b(255, 255, 255), int grayThresh = PS_DEFAULT_BINARY_THRESHOLD);
            /*颜色控件缩减*/
            static PSUTILSHARED_EXPORT Mat lutReduce(Mat src, uchar divideWith);
            ...
            /**
             ...
             @return 结果Mat
            */
            static PSUTILSHARED_EXPORT Mat correctRotation(Mat src, Scalar color, int tolerant = PS_DEFAULT_TOLERANT_ROTATION, int grayThresh = PS_DEFAULT_BINARY_THRESHOLD, int houghVote = PS_DEFAULT_HOUGH_VOTE);
            /**
            @brief: 纠偏
            @param src : the source mat
            @param maxAngle: 角度阈值
            ...
            @return 结果Mat
            */
            static PSUTILSHARED_EXPORT Mat correctRotation(Mat src, int tolerant = PS_DEFAULT_TOLERANT_ROTATION, int grayThresh = PS_DEFAULT_BINARY_THRESHOLD, int houghVote = PS_DEFAULT_HOUGH_VOTE);
            ...
            /**
             ...
             @return 结果Mat
            */
            static PSUTILSHARED_EXPORT void erase(Mat src, Rect range);
            ...
            /*
             ...
             @return 结果Mat
            */
            static PSUTILSHARED_EXPORT Mat zoom(Mat src, double scale);
            ...
            /*
             ...
             @return 结果Mat
            */
            static PSUTILSHARED_EXPORT Mat resize(Mat src, Size dSize);
            ...
            /*
             ...
             @return 结果Mat
            */
            static PSUTILSHARED_EXPORT Mat rotate(Mat src, int angle, Scalar padding = Scalar::all(255), Size dSize = Size());


            static PSUTILSHARED_EXPORT Mat contrastAndBrightness(Mat src, float alpha, float beta);

            static PSUTILSHARED_EXPORT Mat binaryzation(Mat src, int grayThresh = PS_DEFAULT_BINARY_THRESHOLD);

            /*反转二值图片的前景与背景*/
            static PSUTILSHARED_EXPORT Mat reverseBinBgFg(Mat binary);
            ...
            /*
             ...
             @return 结果Mat
             */
            static PSUTILSHARED_EXPORT Mat mergeClean(Mat srcBGR, Mat grayClean, Vec3b newbg = Vec3b(255,255,255 ));

            /*调整色调（Hue）、饱和度（Saturation）、亮度（Value）*/
            static PSUTILSHARED_EXPORT Mat setHSV(Mat srcBGR, uchar h, uchar s, uchar v);
             ...
             */
            static PSUTILSHARED_EXPORT void sharpBGR(Mat& srcBGR, const HsvRngBGR bgrRng,const Vec3b standard[3] = PS_STANDARD_BGR);
             ...
             */
            static PSUTILSHARED_EXPORT void textfill(Mat& srcBGR, int grayThresh = PS_DEFAULT_BINARY_THRESHOLD, Size morph_size = Size(3,3), Vec3b padding = Vec3b(0,0,0));
             ...
             */
            static PSUTILSHARED_EXPORT void partitionCopyPaste(Mat& srcBGR, const Mat refMat, Rect range, Point2i target);
            ...
            /**
             ...
             @return 结果三通道BGR图
            */
            static PSUTILSHARED_EXPORT void replaceColors(Mat& srcBGR, Rect range, Vec3b(*colors)[2]);
        };   
...
//class PSUTILSHARED_EXPORT Psutil
//{
